...
pub enum Event {
	...
	PaymentClaimable {
		...
		via_channel_id_pairs: Vec<(ChannelId, Option<u128>)>,
	...
	fn write<W: Writer>(&self, writer: &mut W) -> Result<(), io::Error> {
		match self {
			...
			&Event::PaymentClaimable { ref payment_hash, ref amount_msat, counterparty_skimmed_fee_msat,
				ref purpose, ref receiver_node_id, ref via_channel_id_pairs,
				...
				let (via_channel_id_legacy, via_user_channel_id_legacy) = match via_channel_id_pairs.last() {
				...
				write_tlv_fields!(writer, {
					...
					(15, *via_channel_id_pairs, optional_vec),
				});
			},
		...
		match Readable::read(reader)? {
			...
			1u8 => {
				let mut f = || {
					...
					let mut via_channel_id_pairs_opt = None;
					read_tlv_fields!(reader, {
						...
						(11, payment_context, option),
						(13, payment_id, option),
						(15, via_channel_id_pairs_opt, optional_vec),
					});
					...
					let via_channel_id_pairs = via_channel_id_pairs_opt

...
pub(crate) struct ReceiveTlvs {
	...
	/// the right context.
	pub path_id: Option<RecipientData>
}
...
impl_writeable_tlv_based_enum!(RecipientData, ;
	(0, OffersContext),
	(1, CustomContext),
);

impl_writeable_tlv_based_enum!(OffersData, ;
	(0, WithPaymentId),
	(1, Empty),
);
...
pub(super) fn blinded_hops<T: secp256k1::Signing + secp256k1::Verification>(
	...
	let tlvs = pks.clone()
		...
		.chain(core::iter::once(ControlTlvs::Receive(ReceiveTlvs{ path_id: recipient_data })));

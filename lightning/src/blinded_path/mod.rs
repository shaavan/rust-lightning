...
impl BlindedPath {
	...
	pub fn one_hop_for_message<ES: Deref, T: secp256k1::Signing + secp256k1::Verification>(
		...
		Self::new_for_message(&[], recipient_node_id, 0, context, entropy_source, secp_ctx)
	}
	...
	pub fn new_for_message<ES: Deref, T: secp256k1::Signing + secp256k1::Verification>(
		...
		dummy_hops: usize, context: MessageContext, entropy_source: ES,
		...
		Ok(BlindedPath {
			...
			blinded_hops: message::blinded_hops(
				secp_ctx, intermediate_nodes, recipient_node_id, dummy_hops,

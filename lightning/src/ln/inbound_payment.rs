...
/// Equivalent to [`crate::ln::channelmanager::OffersMessageCommons::create_inbound_payment`], but no
...
///
/// [`NodeSigner::get_inbound_payment_key_material`]: crate::sign::NodeSigner::get_inbound_payment_key_material
/// [`create_inbound_payment`]: crate::ln::channelmanager::OffersMessageCommons::create_inbound_payment

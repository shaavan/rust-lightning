...
use crate::sign::{EntropySource, OutputSpender, NodeSigner, SignerProvider};
...
pub fn test_key_derivation_params() {
	...
	let message_router = test_utils::TestMessageRouter::new(network_graph.clone(), &keys_manager, keys_manager.get_expanded_key());
	let node = NodeCfg {

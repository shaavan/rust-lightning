...
use crate::ln::outbound_payment::{OutboundPayments, PendingOutboundPayment, SendAlongPathArgs};
	...
	L::Target: Logger,
{
	...
	pub fn new(
		fee_est: F, chain_monitor: M, tx_broadcaster: T, router: R, logger: L,
...
impl<M: Deref, T: Deref, ES: Deref, NS: Deref, SP: Deref, F: Deref, R: Deref, L: Deref> OffersMessageCommons for ChannelManager<M, T, ES, NS, SP, F, R, L>
where
	M::Target: chain::Watch<<SP::Target as SignerProvider>::EcdsaSigner>,
	T::Target: BroadcasterInterface,
	ES::Target: EntropySource,
	...
	L::Target: Logger,
{
	...
	pub fn new(
		...
		chain_monitor: M, tx_broadcaster: T, router: R, logger: L,
		...
		Self {
			...
			tx_broadcaster, router, logger, default_config,

...
use crate::routing::router::{BlindedTail, InFlightHtlcs, Path, Payee, PaymentParameters, Route, RouteParameters, RouteParametersOverride, Router};
...
/// # use lightning::routing::router::RouteParametersOverride;
/// #
...
/// #     payer_note: Option<String>, retry: Retry, route_params_override: Option<RouteParametersOverride>
/// # ) {
/// # let channel_manager = channel_manager.get_cm();
/// let payment_id = PaymentId([42; 32]);
/// match channel_manager.pay_for_offer(
///     offer, quantity, amount_msats, payer_note, payment_id, retry, route_params_override
/// ) {
...
macro_rules! create_refund_builder { ($self: ident, $builder: ty) => {
	...
	pub fn create_refund_builder(
		...
		let route_params_override = max_total_routing_fee_msat.map(
			|fee_msat| RouteParametersOverride::new()
		...
		$self.pending_outbound_payments
			.add_new_awaiting_invoice(
				payment_id, expiration, retry_strategy, route_params_override, None,
			)
	...
	L::Target: Logger,
{
	...
	pub fn pay_for_offer(
		...
		self.pending_outbound_payments
			.add_new_awaiting_invoice(
				payment_id, expiration, retry_strategy, route_params_override,

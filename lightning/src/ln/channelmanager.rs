	...
	L::Target: Logger,
{
	...
	fn get_response_for_invoice_request(&self, invoice_request: InvoiceRequest, context: Option<&MessageContext>, custom_amount_msats: Option<u64>) -> Result<OffersMessage, Bolt12ResponseError> {
		let secp_ctx = &self.secp_ctx;
		let expanded_key = &self.inbound_payment_key;

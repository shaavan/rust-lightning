	...
	L::Target: Logger,
{
	...
	active_outbound_recurrence_sessions: Mutex<HashMap<RecurrenceId, OutboundRecurrenceSessionData>>,
	...
	L::Target: Logger,
{
	...
	pub fn cancel_recurrence(&self, recurrence_id: RecurrenceId) -> Result<(), Bolt12SemanticError> {

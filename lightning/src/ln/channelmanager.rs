...
use crate::offers::offer::{InboundRecurrenceSessionData, Offer, OfferFromHrn, OutboundRecurrenceSessionData, RecurrenceFields};
	...
	L::Target: Logger,
{
	fn read<Reader: io::Read>(
		...
		let channel_manager = ChannelManager {
			...
			active_inbound_recurrence_sessions: Mutex::new(active_inbound_recurrence_sessions.unwrap()),
			active_outbound_recurrence_sessions: Mutex::new(active_outbound_recurrence_sessions.unwrap()),

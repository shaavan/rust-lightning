	...
	MR::Target: MessageRouter,
{
	...
	/// Verifies the provided [`AsyncPaymentsContext`] for an inbound [`AsyncPaymentsMessage`].
	///
	...
	/// Verifies the provided [`AsyncPaymentsContext`] for an outbound [`AsyncPaymentsMessage`].
	///

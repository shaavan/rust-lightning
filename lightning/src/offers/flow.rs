...
use crate::offers::invoice_request::{Bolt12Assessor, InvoiceRequest, InvoiceRequestBuilder};
	...
	L::Target: Logger,
{
	...
	pub fn new(
		...
		entropy_source: ES, commons: OMC, bolt12_assessor: BA, message_router: MR, logger: L,
	) -> Self {
	...
	fn handle_message(
		...
		match message {
			OffersMessage::InvoiceRequest(invoice_request) => {
				...
				let amount_msats =
					match self.bolt12_assessor.assess_invoice_request(&invoice_request.inner) {

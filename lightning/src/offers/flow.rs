	...
	MR::Target: MessageRouter,
{
	...
	pub fn create_offer_builder<ES: Deref, I>(
		&self, entropy_source: ES, absolute_expiry: Option<Duration>, peers: I,
	...
	pub fn create_refund_builder<ES: Deref, I>(
		&self, entropy_source: ES, amount_msats: u64, absolute_expiry: Duration,
		payment_id: PaymentId, peers: I,
	...
	pub fn enqueue_invoice_request<I>(
		&self, invoice_request: InvoiceRequest, payment_id: PaymentId, nonce: Nonce, peers: I,
	...
	///
	/// [`supports_onion_messages`]: crate::types::features::Features::supports_onion_messages
	pub fn enqueue_invoice<ES: Deref, I>(
		&self, entropy_source: ES, invoice: Bolt12Invoice, refund: &Refund, peers: I,
	) -> Result<(), Bolt12SemanticError>
	where
		ES::Target: EntropySource,
		I: IntoIterator<Item = MessageForwardNode>,
	...
	/// [`supports_onion_messages`]: crate::types::features::Features::supports_onion_messages
	#[cfg(async_payments)]
	pub fn enqueue_held_htlc_available<ES: Deref, I>(
		&self, entropy_source: ES, invoice: &StaticInvoice, payment_id: PaymentId, peers: I,
	) -> Result<(), Bolt12SemanticError>
	where
		ES::Target: EntropySource,
		I: IntoIterator<Item = MessageForwardNode>,
	...
	/// [`supports_onion_messages`]: crate::types::features::Features::supports_onion_messages
	#[cfg(feature = "dnssec")]
	pub fn enqueue_dns_onion_message<I>(

	...
	MR::Target: MessageRouter,
{
	...
	>(
		...
		currency_conversion: &CC, usable_channels: Vec<ChannelDetails>, get_payment_info: F,
	...
	/// Enqueues the provided [`Bolt12Invoice`] to be sent directly to the specified [`PublicKey`] `destination`.
	///
	/// This method should be used when there are no available [`BlindedMessagePath`]s for routing the
	/// [`Bolt12Invoice`] and the counterparty’s node ID is known.
	///
	/// # Parameters
	///
	/// - `invoice`: The [`Bolt12Invoice`] to be sent.
	/// - `destination`: The [`PublicKey`] of the destination node.
	/// - `peers`: A list of [`MessageForwardNode`]s used to generate blinded reply paths.
	///
	...
	/// Enqueues the provided [`Bolt12Invoice`] to be sent using the given [`BlindedMessagePath`]s.
	///
	/// This method is used when the counterparty expects to receive invoices through
	/// onion-routed paths for privacy or anonymity.
	///
	/// # Parameters
	///
	/// - `invoice`: The [`Bolt12Invoice`] to be sent.
	/// - `paths`: A list of [`BlindedMessagePath`]s representing potential destinations.
	/// - `peers`: A list of [`MessageForwardNode`]s used to generate blinded reply paths.
	///
	/// # Reply Path Requirement
	///

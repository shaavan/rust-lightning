...
use crate::ln::channelmanager::{
	ChainParameters, PaymentId, CLTV_FAR_FAR_AWAY, MAX_SHORT_LIVED_RELATIVE_EXPIRY,
};
...
pub trait Flow: chain::Listen {
	...
	fn create_response_for_invoice_request<NS: Deref>(
	...
	R::Target: Router,
{
	...
	pub fn new(
		params: ChainParameters, our_network_pubkey: PublicKey, current_timestamp: u32,
		inbound_payment_key: inbound_payment::ExpandedKey, entropy_source: ES, message_router: MR,
		router: R,
	) -> Self {

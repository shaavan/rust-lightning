...
impl<'a> MessageRouter for TestRouter<'a> {
	...
	>(
		...
		self.router.create_blinded_paths(recipient, recipient_tlvs, peers, secp_ctx)
	}
	...
	>(
		...
		self.router.create_compact_blinded_paths(recipient, recipient_tlvs, peers, secp_ctx)
	}
}

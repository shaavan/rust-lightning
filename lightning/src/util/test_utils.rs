...
impl<'a> MessageRouter for TestMessageRouter<'a> {
	...
	fn create_blinded_paths<T: secp256k1::Signing + secp256k1::Verification>(
		...
		self.inner.create_blinded_paths(recipient, context, peers, secp_ctx, local_node_receive_key)
	}
	...
	fn create_compact_blinded_paths<T: secp256k1::Signing + secp256k1::Verification>(
		...
		self.inner.create_compact_blinded_paths(recipient, context, peers, secp_ctx, local_node_receive_key)
	}
}

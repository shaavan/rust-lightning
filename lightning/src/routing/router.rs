...
use crate::blinded_path::message::{self, RecipientData};
	...
	ES::Target: EntropySource,
{
	...
	> (
		...
		self.message_router.create_blinded_paths(recipient, recipient_tlvs, peers, secp_ctx)
	}

	fn create_compact_blinded_paths<
		T: secp256k1::Signing + secp256k1::Verification
	> (
		&self, recipient: PublicKey, recipient_tlvs: Option<RecipientData>, peers: Vec<message::ForwardNode>, secp_ctx: &Secp256k1<T>,
	) -> Result<Vec<BlindedPath>, ()> {
		self.message_router.create_compact_blinded_paths(recipient, recipient_tlvs, peers, secp_ctx)
	}
}

	...
	ES::Target: EntropySource,
{
	...
	fn create_compact_blinded_paths<
		T: secp256k1::Signing + secp256k1::Verification
	> (
		&self, recipient: PublicKey, recipient_data: Option<RecipientData>, peers: Vec<message::ForwardNode>, secp_ctx: &Secp256k1<T>,
	) -> Result<Vec<BlindedPath>, ()> {
		self.message_router.create_compact_blinded_paths(recipient, recipient_data, peers, secp_ctx)
	}
}

...
impl OffersMessageHandler for TestOffersMessageHandler {
	fn handle_message(&self, _message: OffersMessage, _responder: Option<Responder>, _recipient_data: OffersData) -> ResponseInstruction<OffersMessage> {
...
impl CustomOnionMessageHandler for TestCustomMessageHandler {
	...
	fn handle_custom_message(&self, msg: Self::CustomMessage, responder: Option<Responder>, _recipient_data: Vec<u8>) -> ResponseInstruction<Self::CustomMessage> {
